...
BEGIN Scenario
    Name		 Hohmann_Split_Plane_Change

    BEGIN Epoch

        Epoch		 3 Nov 2017 00:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 3 Nov 2017 00:00:00.000000000
            EpochState		 Explicit
    ...
    BEGIN Interval
        ...
        Start		 31 Oct 2017 19:42:00.000000000
        Stop		 3 Nov 2017 00:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 31 Oct 2017 19:42:00.000000000
    ...
    BEGIN ScenarioLicenses
        ...
        Module		 Radarv11.3
        Module		 SEETv11.3
        Module		 STKIntegrationv11.3
        Module		 STKProfessionalv11.3
        Module		 STKv11.3
        Module		 SatProv11.3
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 1.38107e+07
            LaunchWindowStop		 1.37088e+07
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 9 Apr 2018 16:00:00.000000000
                    Stop		 10 Apr 2018 16:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
...
<VAR name = "STK_Radar_Clutter_Extension">
    <SCOPE Class = "RadarClutterExtension">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 31 Oct 2017 19:42:00.000000000
                EndTime		 3 Nov 2017 00:00:00.000000000
                CurrentTime		 1 Nov 2017 11:57:07.570000000
                Mode		 Stop
                Direction		 Forward
                UpdateDelta		 60
            ...
            BEGIN MapData
                ...
                BEGIN Map
                    ...
                    BEGIN MapAttributes
                        ...
                        SecondaryBody		 Sun
                        CenterLatitude		 0
                        CenterLongitude		 117.8102189781022
    ...
    BEGIN References
        Instance *
            *		
        END Instance
        Instance Satellite/Koreasat5a
            Satellite/Koreasat5a		
        END Instance
    END References
